...
function updateDataset(url) {
    ...
    async function updateData(id, portfolio, name, email, phone) {
...
function populateTable(data) {
    ...
    if (data) {
      ...
      <td colspan="1" style="width: 25%; word-break: break-all;">${data.portfolio}</td>
...
async function editRow(id) {
    ...
    const { portfolio, name, email, phone, _id } = selectedData;
...
async function deleteRow(id) {
    ...
    // Access individual properties of the selected object
    const { portfolio, name, email, phone, _id, id: Id, images } = selectedData;
    ...
    // pass values from api to each element
    document.getElementById('portfolioD').value = portfolio
...
async function handleUpdate() {
    ...
    await updateData(id, portfolio, name, email, phone)
...
async function handleDelete() {
    ...
    // const portfolio = document.getElementById('titleD').value
