...
// const secondApi = 'https://spiritan.vercel.app/api/structure_content'
...
function createDataset(url) {
    ...
    async function createData(portfolio, name, email, phone) {
        // console.log('27')
...
async function handleSubmit(event) {
    ...
    try {
        ...
        await createData(portfolio, name, email, phone);
         // window.location.href = redirectUrl;
    } catch (error) {
